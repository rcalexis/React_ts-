...
export const useCart = ()=> {
  ...
  return localstorageCart ? JSON.parse(localstorageCart) : [];
    ...
    const [cart,setCart]= useState<cartItem[]>(loadcart) // aqui le estamos diciendo que cart siempre va a contener objetos de tipo cartitem
...
/////////////////////////////////////
    ...
    //Aquí no le das un tipo explícito a guitar, y TypeScript lo infiere automáticamente como cartItem, ya que sabe que cart es un arreglo de cartItem[].
